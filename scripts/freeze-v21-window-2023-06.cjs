...
const CONFIG_PATH = path.join(__dirname, '..', 'config', 'v21_window_2023_06.json');
const OUTPUT_JSON = path.join(__dirname, '..', 'research', 'v21_2023_06_selection.json');
const OUTPUT_MD = path.join(__dirname, '..', 'research', 'v21_2023_06_selection.md');
...
`;
  ...
  fs.writeFileSync(OUTPUT_MD, `# V2.1 June 2023 selection freeze
