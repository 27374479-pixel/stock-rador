...
const LOCK = JSON.parse(fs.readFileSync(path.join(__dirname, '..', 'frozen', 'v21_2023_06_selection.json'), 'utf8'));
const CONFIG = JSON.parse(fs.readFileSync(path.join(__dirname, '..', 'config', 'v21_window_2023_06.json'), 'utf8'));
const OUTPUT_JSON = path.join(__dirname, '..', 'research', 'v21_2023_06_outcomes.json');
const OUTPUT_MD = path.join(__dirname, '..', 'research', 'v21_2023_06_outcomes.md');

const HORIZONS = [20, 60, 120, 250];
const PRICE_START = '2023-05-01';
const PRICE_END = '2024-08-31';
...
`;
  ...
  fs.writeFileSync(OUTPUT_MD, `# V2.1 June 2023 outcome evaluation
