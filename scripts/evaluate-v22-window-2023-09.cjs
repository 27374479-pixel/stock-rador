...
const LOCK = JSON.parse(fs.readFileSync(path.join(__dirname, '..', 'frozen', 'v22_2023_09_selection.json'), 'utf8'));
const CONFIG = JSON.parse(fs.readFileSync(path.join(__dirname, '..', 'config', 'v22_window_2023_09.json'), 'utf8'));
const OUTPUT_JSON = path.join(__dirname, '..', 'research', 'v22_2023_09_outcomes.json');
const OUTPUT_MD = path.join(__dirname, '..', 'research', 'v22_2023_09_outcomes.md');

const HORIZONS = [20, 60, 120, 250];
const PRICE_START = '2023-08-01';
const PRICE_END = '2024-11-30';
...
`;
  ...
  fs.writeFileSync(OUTPUT_MD, `# V2.2 September 2023 outcome evaluation
