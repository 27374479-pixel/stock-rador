...
function validateOpportunityMemo(memo, memoPath, manifest) {
  ...
  if (['1.3', '1.4'].includes(manifest?.schemaVersion) && memo?.selectionState !== 'No selection') {
    ...
    if (!burden || typeof burden !== 'object') {
      ...
      const primary = manifest.primarySelectionStates.includes(memo.selectionState);
      const v07ResetSubstitute = ['0.7.0', '0.8.0', '0.9.0', '1.0.0', '1.1.0', '1.2.0', '1.3.0', '1.4.0', '1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version) &&
  ...
  if (['0.7.0', '0.8.0', '0.9.0', '1.0.0', '1.1.0', '1.2.0', '1.3.0', '1.4.0', '1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version) && memo?.selectionState !== 'No selection') {
  ...
  if (['1.2.0', '1.3.0', '1.4.0', '1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version) && memo?.selectionState !== 'No selection') {
    const primary = manifest.primarySelectionStates.includes(memo.selectionState);
    ...
    if (!pathTest || typeof pathTest !== 'object') {
      ...
      if (primary) {
        const v15BaseHorizonRoute =
          ['1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version) &&
  ...
  if (['1.3.0', '1.4.0', '1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version) && memo?.selectionState !== 'No selection') {
    const archetypes = [
  ...
  if (['1.4.0', '1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version)) {
  ...
  if (['0.8.0', '0.9.0', '1.0.0', '1.1.0', '1.2.0', '1.3.0', '1.4.0', '1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version) && memo?.selectionState !== 'No selection') {
    const primary = manifest.primarySelectionStates.includes(memo.selectionState);
    ...
    if (!timing || typeof timing !== 'object') {
      ...
      if (primary) {
        const v10EngineOverride =
          ['1.0.0', '1.1.0', '1.2.0', '1.3.0', '1.4.0', '1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version) &&
    ...
    if (!asym || typeof asym !== 'object') {
      ...
      if (primary) {
        const v09TurningPoint = ['0.9.0', '1.0.0', '1.1.0', '1.2.0', '1.3.0', '1.4.0', '1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version) &&
        ...
        if (['1.3.0', '1.4.0', '1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version)) {
  ...
  if (['0.9.0', '1.0.0', '1.1.0', '1.2.0', '1.3.0', '1.4.0', '1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version) && memo?.selectionState !== 'No selection') {
    const primary = manifest.primarySelectionStates.includes(memo.selectionState);
  ...
  if (['1.0.0', '1.1.0', '1.2.0', '1.3.0', '1.4.0', '1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version) && memo?.selectionState !== 'No selection') {
    const primary = manifest.primarySelectionStates.includes(memo.selectionState);

    const v15BaseHorizonRoute = ['1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version) && memo?.timingRoute === 'base_horizon_convexity';
    const allowedTimingRoutes = ['1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version)
    ...
    if (memo?.timingRoute === 'company_engine_override') {
      if (!override || typeof override !== 'object') {
        ...
        if (!dislocation || typeof dislocation !== 'object') {
          ...
          const isV11 = ['1.1.0', '1.2.0', '1.3.0', '1.4.0', '1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version);
        ...
        if (primary) {
          ...
          const directionalV11Plus = ['1.1.0', '1.2.0', '1.3.0', '1.4.0', '1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version);
  ...
  if (['1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version) && memo?.selectionState !== 'No selection') {
  ...
  if (['1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version)) {
  ...
  if (['1.7.0', '1.8.0'].includes(manifest?.skill?.version) && memo?.selectionState !== 'No selection') {
  ...
  if (manifest?.skill?.version === '1.8.0') {
...
function validateMemoForSelection(memo, selection, manifest) {
  ...
  if (isV12 && memo?.selectionState !== 'No selection') {
    ...
    const isV13 = ['1.3.0', '1.4.0', '1.5.0', '1.6.0', '1.7.0', '1.8.0'].includes(manifest?.skill?.version);
