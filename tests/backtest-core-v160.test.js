...
const { classifyCompanyPriceDislocation, validateOpportunityMemo } = require('../scripts/backtest-core-v160.cjs');

function manifest() {
  return {
    schemaVersion: '1.4',
    runId: 'v160-test',
    skill: { path: 'skills/stock-rador/versions/1.6.0/SKILL.md', version: '1.6.0' },
